...
feature_dir = '../../dataset/processed/hw/comp_feature/'
save_dir = '../../dataset/processed/hw/'
features_files = {
    '0': '0_features.npy',
    '0.5': '0.5_features.npy',
    '1.0': '1.0_features.npy',
    '1.5': '1.5_features.npy',
    '2.0': '2.0_features.npy',
    '2.5': '2.5_features.npy',
    '3.0': '3.0_features.npy',
    '3.5': '3.5_features.npy',
    '4.0': '4.0_features.npy',
}
...
def main(features_key, longtail_threshold=10, ablation=None, advanced=False):
    ...
    if ablation == "no_category":
        features = [x for x in features if x != "category"]
