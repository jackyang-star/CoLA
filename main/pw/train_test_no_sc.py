...
train_test_data_path = "../../dataset/processed/pw/processed_data_1.0_no_sc.pth"
graph_data_path = "../../dataset/processed/pw/graphs_1.0_no_sc.bin"
longtail_data_path = "../../dataset/processed/pw/longtail_data_threshold_4.npy"
logdir = "../../log/pw/ablation/no_sc"
# model parameters
embedding_dim = 64
